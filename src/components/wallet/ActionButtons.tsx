...
import { CardSystemDesign } from './designs/CardSystemDesign'
...
export const ActionButtons = ({ 
  ...
  // Si designStyle no es 'current', usar el componente de diseño específico
  if (designStyle !== 'current') {
    const commonProps = {
      tickets,
      onViewTickets,
      onContactSupport,
    ...
    switch (designStyle) {
      ...
      case 'cards':
        return <CardSystemDesign {...commonProps} />
      case 'ios':
        return <IOSStyleDesign {...commonProps} />
      case 'brutal':
